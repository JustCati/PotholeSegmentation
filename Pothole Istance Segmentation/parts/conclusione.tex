...
This bad labelling of the dataset is not only a problem for the training process of the model, but also for its evaluation. 
...
The second problem is the lack of non maximum suppression during the forward of the model itself: this leaves the model to predict multiple instances of the same object in the image.
