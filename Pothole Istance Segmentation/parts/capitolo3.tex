...
\begin{figure}[ht]
    ...
    \caption{Example of the images after the augmentation. On the left the resulting mask, on the right the original image with labels after augmentation.}
...
In particular, we just added the following techniques:
\begin{itemize}
