...
In this chapter we will talk about the related information to the project such as the segmentation task itself and the metrics used throughout the project.
...
In this project, we will focus on mAP (mean Average Precision) that use the IoU (Intersection over Union) metric at different thresholds.
...
It is calculated as the area of overlap divided by the area of union between the two, as shown in the following formula:
