...
The latter is actually not used in the final implementation of the model, but it is still present in the code. The reason behind this is shown in the Experiments section.
